export default function Post() {
    return (
        <>
            ...
            <div className="grid grid-cols-1 gap-2 lg:px-2 mb-4 ">
                <div className="max-w-xl mx-auto px-4 py-4 dark:bg-slate-700 shadow-md lg:rounded-lg">
                    <div className="py-2 flex flex-row items-center justify-between">
                        ...
                        <div className="flex flex-row items-center">
                            <p className="text-xs font-semibold dark:text-slate-300">2 hours ago</p>
                        </div>
                    </div>
                    <div className="mt-2">
                        ...
                        <div className="py-2 flex flex-row items-center">
                            <button className="flex flex-row items-center focus:outline-none focus:shadow-outline rounded-lg">
                                <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} viewBox="0 0 24 24" className="w-5 h-5 dark:text-red-500"><path d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z" /></svg>
                                <span className="ml-1 dark:text-slate-200">3431</span>
                            </button>
                            <button className="flex flex-row items-center focus:outline-none focus:shadow-outline rounded-lg ml-3">
                                ...
                                <span className="ml-1 dark:text-slate-200">566</span>
                            </button>
                            <button className="flex flex-row items-center focus:outline-none focus:shadow-outline rounded-lg ml-3">
                                <svg fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} viewBox="0 0 24 24" className="w-5 h-5 dark:text-slate-200"><path d="M8.684 13.342C8.886 12.938 9 12.482 9 12c0-.482-.114-.938-.316-1.342m0 2.684a3 3 0 110-2.684m0 2.684l6.632 3.316m-6.632-6l6.632-3.316m0 0a3 3 0 105.367-2.684 3 3 0 00-5.367 2.684zm0 9.316a3 3 0 105.368 2.684 3 3 0 00-5.368-2.684z" /></svg>
                                <span className="ml-1 dark:text-slate-200">340</span>
                            </button>
                        </div>
                    </div>
                    <div className="py-2">
                        <p className="leading-snug dark:text-slate-200">Lorem ipsum dolor sit amet consectetur adipisicing elit. Et, ratione dicta deleniti, quas distinctio, veniam quo rem eveniet aliquid repudiandae fuga asperiores reiciendis tenetur? Eius quidem impedit et soluta accusamus.</p>
                    </div>
                </div>
                <div className="max-w-xl mx-auto px-4 py-4 dark:bg-slate-700 shadow-md lg:rounded-lg">
                    <div className="py-2 flex flex-row items-center justify-between">
